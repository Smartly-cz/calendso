...
const dirnamePolyfill = path.join(process.cwd(), "prisma/node_modules/.prisma/client")
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/honza/dev/SmartlyCal/calendso/prisma/node_modules/@prisma/client",
      "fromEnvVar": null
    },
    "config": {},
    "binaryTargets": [],
...
path.join(process.cwd(), './prisma/node_modules/.prisma/client/query-engine-darwin');
